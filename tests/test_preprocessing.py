...
from sentiment_analysis_service.preprocessing import preprocess_text, preprocess_batch # Import functions to test

# --- Tests for preprocess_text ---

def test_preprocess_text_standard():
    """Test standard case with mixed case and punctuation."""
    assert preprocess_text("This Product is AMAZING!! Highly recommend.") == "this product is amazing highly recommend"
...
def test_preprocess_text_numbers_and_text():
    ...
    assert preprocess_text("Version 5.0 is great!") == "version 50 is great" # Note: '.' is removed
